      ...
      <div className='container'>
        <div className="card">
          <div className="row">
            ...
            <div className="col-8">
              <div><b>Type:</b> {this.props.id.type}</div>
              <div><b>Abilities:</b> {this.props.id.abilities}</div>
              <div><b>Stats:</b> {this.props.id.stats}</div>
              <div><b>Weight:</b> {this.props.id.weight}</div>
            </div>
          </div>
          <button
            type="button"
